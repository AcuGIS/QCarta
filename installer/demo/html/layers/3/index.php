        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <div class="metadata-item">
              ...
              <strong>Bounding Box:</strong> 46.806325,9.249581,46.815363,9.263862
            </div>
            <div class="metadata-item">
            ...
            <div id="inspireMetadata" class="accordion-collapse collapse" data-bs-parent="#metadataAccordion">
              <div class="accordion-body">
                ...
                <div class="metadata-item">
                  ...
                  <strong>Spatial Data Service URL:</strong> <?=$proto."://".$_SERVER['HTTP_HOST']."proxy_qgis.php"?>
                </div>
              </div>
            </div>
          </div>
