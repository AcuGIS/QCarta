...
sed -i.save 's/127.0.0.1:8011/qcarta-tiles:8011/' /var/www/html/admin/snippets/proxy_qgis.php
sed -i.save 's/127.0.0.1:8011/qcarta-tiles:8011/' /var/www/html/admin/actions/clean_project_cache.php
...
for i in 2 3; do
    ...
    sed -i.save 's/127.0.0.1:8011/qcarta-tiles:8011/' /var/www/html/layers/${i}/proxy_qgis.php
done
