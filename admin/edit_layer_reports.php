<?php
    ...
    require('class/layer_report.php');
	...
	$obj = new layer_report_Class($dbconn, $_SESSION[SESS_USR_KEY]->id);
...
<head>
	...
	<script src="assets/dist/js/edit_layer_reports.js"></script>
</head>
...
<body>
	...
	<div id="container">
		...
		<?php const NAV_SEL = 'SQL Reports'; const TOP_PATH='../'; const ADMIN_PATH='';
		...
		<div id="content">
				...
				<h1>Edit SQL Reports for layer <?=$_GET['id']?></h1>
			<div style="width: 99%">
							...
							<div class="modal-content">
								<div class="modal-header bg-primary text-white">
									<h4 class="modal-title mb-0">
										<i class="bi bi-plus-circle me-2"></i>Create New SQL Report
									</h4>
									...
									<form id="query_form" action="" method="post">
										...
										<div class="row mb-4">
											...
											<div class="col-md-6 mb-3">
												<label for="name" class="form-label fw-semibold">
													<i class="bi bi-tag me-1"></i>Report Name
												</label>
										...
										<div class="row mb-4">
											...
											<div class="col-12 mb-3">
												...
												<small class="form-text text-muted">Select the database type for this report</small>
											</div>
										</div>
