...
<head>
  ...
  <link rel="stylesheet" href="../../assets/dist/css/map_index.css?v=fp16">
  ...
  <script>
    ...
    const WMS_SVC_URL = 'WMS_URL?' + ((accessKey.length === 0) ? '' : 'access_key=' + accessKey) + '&_ts=' + Date.now();
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            ...
            <div class="metadata-item">
              ...
              <strong>Bounding Box:</strong> BBOX_MINY,BBOX_MINX,BBOX_MAXY,BBOX_MAXX
            </div>
            <div class="metadata-item">
            ...
            <div id="inspireMetadata" class="accordion-collapse collapse" data-bs-parent="#metadataAccordion">
              <div class="accordion-body">
                ...
                <div class="metadata-item">
                  ...
                  <strong>Spatial Data Service URL:</strong> <?=$proto."://".$_SERVER['HTTP_HOST']."WMS_URL"?>
                </div>
              </div>
            </div>
          </div>
...
<script src="../../assets/dist/js/map_index_lib.js?v=fp34"></script>
<script src="../../assets/dist/js/map_index.js?v=fp33"></script>
<script src="../../assets/dist/js/map_index_controls.js"></script>
<script src="../../assets/dist/js/basemap_manager.js?v=fp33"></script>
<?php if (file_exists($plotly_defaults_file)) { ?>
