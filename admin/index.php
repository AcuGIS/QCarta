					...
					<div class="admin-grid">
						...
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">Configure MapProxy services, caching, and seeding for optimal performance.</p>
								<div class="card-links">
									<a href="services.php" class="card-link">
										<i class="bi bi-gear"></i>
										Manage
									</a>
									<a href="https://QCarta.docs.acugis.com/en/latest/sections/mapproxy/index.html" class="card-link" target="_blank">
										<i class="bi bi-book"></i>
										Documentation
									</a>
								</div>
