<?php
    ...
    function store_filter_values($row, $fv_path){
        ...
        $feat_url = 'http://localhost/cgi-bin/qgis_mapserv.fcgi?VERSION=1.1.1&map='.QGIS_FILENAME_ENCODED.'&service=WFS&version=1.1.1&request=GetFeature&typeName='.$row['feature'].'&OUTPUTFORMAT=application/json';
