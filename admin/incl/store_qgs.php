...
<div class="row">
    <div class="col-8"><p>&nbsp;</p>
			...
			<div class="alert alert-success">
			   <strong>Note:</strong> Upload your .qgs files here. Or create from data files or PostGIS. <a href="https://quail.docs.acugis.com/en/latest/sections/qgisstore/index.html" target="_blank"> Documentation</a>
...
<div id="addnew_modal" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">QGS Upload</h4>
				<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
			</div>
				...
				<form id="qgs_form" class="border shadow p-3 rounded"
    				...
    				<legend class="w-auto">Source</legend>
						...
						<div class="input-group">
							...
							<select class="form-control" name="pg_store_id[]" id="pg_store_id" disabled multiple>
								<?php $sel = 'selected';
								foreach($pg_stores as $k => $v){ ?>
									<option value="<?=$k?>" <?=$sel?>><?=$v?></option>
								<?php $sel = ''; } ?>
							</select>
							<span class="input-group-text"  title="PostGIS"><i class="bi bi-database-up"></i></span>
						</div>
					</fieldset>
